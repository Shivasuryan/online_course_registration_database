...
if(!empty($_POST["submit"])) {
	...
	echo "<br>";
	echo "Money Earned by doing Project is: " ;
    echo 50*$hours_difference . "Bucks";
    $money= 50*$hours_difference;
}
?>
